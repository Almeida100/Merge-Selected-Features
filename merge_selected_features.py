...
from .merge_selected_features_provider import MergeSelectedFeaturesProvider
...
class MergeSelectedFeaturesPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = MergeSelectedFeaturesProvider()
