...
from .merge_selected_features_algorithm import MergeSelectedFeaturesAlgorithm


class MergeSelectedFeaturesProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(MergeSelectedFeaturesAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('Merge selected features')
